...
void InitEPwm10Gpio(void)
{
    ...
    // Comment out other unwanted lines.
    //
    GpioCtrlRegs.GPAPUD.bit.GPIO18 = 1;    // Disable pull-up on GPIO161 (EPWM9A)
    GpioCtrlRegs.GPAPUD.bit.GPIO19 = 1;    // Disable pull-up on GPIO162 (EPWM9B)
...
//    GpioCtrlRegs.GPFMUX1.bit.GPIO164 = 1;   // Configure GPIO164 as EPWM10B
    ...
    GpioCtrlRegs.GPAGMUX2.bit.GPIO18 = 1;   // Configure GPIO161 as EPWM9A
    GpioCtrlRegs.GPAGMUX2.bit.GPIO19 = 1;   // Configure GPIO162 as EPWM9B
    GpioCtrlRegs.GPAMUX2.bit.GPIO18 = 1;   // Configure GPIO161 as EPWM9A
    GpioCtrlRegs.GPAMUX2.bit.GPIO19 = 1;   // Configure GPIO162 as EPWM9B
...
void InitEPwm11Gpio(void)
{
    ...
    // Comment out other unwanted lines.
    //
    GpioCtrlRegs.GPAPUD.bit.GPIO20 = 1;    // Disable pull-up on GPIO161 (EPWM9A)
    GpioCtrlRegs.GPAPUD.bit.GPIO21 = 1;    // Disable pull-up on GPIO162 (EPWM9B)
    ...
    // Comment out other unwanted lines.
    //
    GpioCtrlRegs.GPAGMUX2.bit.GPIO20 = 1;   // Configure GPIO161 as EPWM9A
    GpioCtrlRegs.GPAGMUX2.bit.GPIO21 = 1;   // Configure GPIO162 as EPWM9B
    GpioCtrlRegs.GPAMUX2.bit.GPIO20 = 1;   // Configure GPIO161 as EPWM9A
    GpioCtrlRegs.GPAMUX2.bit.GPIO21 = 1;   // Configure GPIO162 as EPWM9B
